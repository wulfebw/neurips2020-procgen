...
def monet_loss(policy, model, dist_class, train_batch):
    ...
    return model.custom_loss(policy.loss_obj.loss)


MONetTorchPolicy = build_torch_policy(
    name="MONetTorchPolicy",
...
def get_policy_class(config):
    return MONetTorchPolicy


MONetTrainer = build_trainer(name="monet",
                             default_config=DEFAULT_CONFIG,
                             default_policy=MONetTorchPolicy,
